...
[![CI/CD for riverpod_di](https://github.com/Skycoder42/riverpod_di/actions/workflows/riverpod_di_ci.yaml/badge.svg)](https://github.com/Skycoder42/riverpod_di/actions/workflows/riverpod_di_ci.yaml)
[![CI/CD for riverpod_di_generator](https://github.com/Skycoder42/riverpod_di/actions/workflows/riverpod_di_generator_ci.yaml/badge.svg)](https://github.com/Skycoder42/riverpod_di/actions/workflows/riverpod_di_generator_ci.yaml)
[![Pub Version](https://img.shields.io/pub/v/riverpod_di)](https://pub.dev/packages/riverpod_di)
[![Pub Version](https://img.shields.io/pub/v/riverpod_di_generator?label=pub%20riverpod_di_generator)](https://pub.dev/packages/riverpod_di_generator)
...
| -------------------------------------------------------------------------- | ----------------------------------------------- | ----------------- |
| [`riverpod_di`](https://pub.dev/packages/riverpod_di)                       | the annotations                                  | `dependencies`     |
| [`riverpod_di_generator`](https://pub.dev/packages/riverpod_di_generator)   | the builder                                      | `dev_dependencies` |
...
your_file.dart          @riverDi annotated classes
      │
      ├─ riverpod_di_generator ──► your_file.di.g.dart    provider functions
      │                                                    (@Riverpod annotated)
      └─ riverpod_generator ─────► your_file.g.dart       the actual providers
```

`riverpod_di_generator` declares `runs_before: riverpod_generator`, so a single
...
dev_dependencies:
  build_runner: <latest>
  riverpod_di_generator: <latest>
  riverpod_generator: <latest>
```

`riverpod_di` re-exports `riverpod_annotation`, so a single import is enough:

```dart
import 'package:riverpod_di/riverpod_di.dart';

part 'my_file.di.g.dart'; // riverpod_di_generator
...
(`auto_apply: dependents`), and `riverpod_di_generator` only runs for files that
...
See [`async_chain_example.dart`](https://github.com/Skycoder42/riverpod_di/blob/main/packages/riverpod_di_generator/example/async_chain_example.dart)
...
`riverpod_di_generator:riverpod_di_generator`. It understands the same provider
...
The [example directory](https://github.com/Skycoder42/riverpod_di/tree/main/packages/riverpod_di_generator/example)
holds a commented file per topic, each next to the code it generates:

| Example                                                                                                                                | Topic                                                            |
| -------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| [`riverpod_di_generator_example.dart`](https://github.com/Skycoder42/riverpod_di/blob/main/packages/riverpod_di_generator/example/riverpod_di_generator_example.dart) | a tour of everything the generator supports                       |
| [`constructor_shapes_example.dart`](https://github.com/Skycoder42/riverpod_di/blob/main/packages/riverpod_di_generator/example/constructor_shapes_example.dart)       | field formals, `super.` parameters, defaults, optionals and `Ref` |
| [`interfaces_example.dart`](https://github.com/Skycoder42/riverpod_di/blob/main/packages/riverpod_di_generator/example/interfaces_example.dart)                       | injecting an abstraction via `@From`                              |
| [`async_chain_example.dart`](https://github.com/Skycoder42/riverpod_di/blob/main/packages/riverpod_di_generator/example/async_chain_example.dart)                     | asynchronous dependency chains                                    |
| [`dispose_example.dart`](https://github.com/Skycoder42/riverpod_di/blob/main/packages/riverpod_di_generator/example/dispose_example.dart)                             | `@disposeMethod` and `onDispose`                                  |
| [`naming_example.dart`](https://github.com/Skycoder42/riverpod_di/blob/main/packages/riverpod_di_generator/example/naming_example.dart)                               | name derivation and forwarded riverpod options                    |
| [`cross_library_example.dart`](https://github.com/Skycoder42/riverpod_di/blob/main/packages/riverpod_di_generator/example/cross_library_example.dart)                 | dependencies declared in another library                          |

## Documentation

The API documentation is available at
[pub.dev](https://pub.dev/documentation/riverpod_di/latest/riverpod_di/riverpod_di-library.html).
Bugs and feature requests belong into the
[issue tracker](https://github.com/Skycoder42/riverpod_di/issues).

Licensed under the [BSD 3-Clause License](https://github.com/Skycoder42/riverpod_di/blob/main/LICENSE).
